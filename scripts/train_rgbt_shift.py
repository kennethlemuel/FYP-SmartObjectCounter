...
def main() -> None:
    ...
    ap.add_argument("--thermal_shift_px", type = int, default = 0,
                    help = "Max absolute thermal-only shift in pixels applied after crop/flip during training.")
    ap.add_argument("--thermal_shift_p", type = float, default = 0.0,
                    help = "Probability of applying thermal-only shift augmentation on each training sample.")
    ...
    print(f"[init] thermal_shift_px = {args.thermal_shift_px}  thermal_shift_p = {args.thermal_shift_p:.2f}")
    ...
    if args.mode == "rgb":
        ...
        ds_train = RGBTCC_RGBTBaseDset(
            ...
            is_train = True,
            deterministic = is_train_det,
            thermal_shift_px = args.thermal_shift_px,
            thermal_shift_p = args.thermal_shift_p,
        )
