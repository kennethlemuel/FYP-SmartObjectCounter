...
def build_model(
    ...
    if mode == "adaptive_fpn_lite_cal_align":
    ...
    if mode == "adaptive_fpn_lite_cal_dualstem":
        return CSRNetRGBT_AdaptiveFPNLiteCalDualStem(load_imagenet = load_imagenet)
...
def build_dataset(
    ...
    if mode in ["base", "adaptive_fpn_lite", "adaptive_fpn_lite_cal", "adaptive_fpn_lite_cal_align", "adaptive_fpn_lite_cal_conf", "adaptive_fpn_lite_cal_dualstem", "adaptive_fpn_lite_cal_misalign"]:
...
def forward_density(model: torch.nn.Module, mode: str, batch: Tuple[Any, ...], device: torch.device) -> torch.Tensor:
    ...
    if mode in ["rgb", "t", "base", "adaptive_fpn_lite", "adaptive_fpn_lite_cal", "adaptive_fpn_lite_cal_align", "adaptive_fpn_lite_cal_conf", "adaptive_fpn_lite_cal_dualstem", "adaptive_fpn_lite_cal_misalign"]:
...
def benchmark_forward(
    ...
    if mode.lower() in ["rgb", "t", "base", "adaptive_fpn_lite", "adaptive_fpn_lite_cal", "adaptive_fpn_lite_cal_align", "adaptive_fpn_lite_cal_conf", "adaptive_fpn_lite_cal_dualstem", "adaptive_fpn_lite_cal_misalign"]:
        x = batch[0].to(device, non_blocking = True)
        batch_on_device = (x,)
    else:
        rgb = batch[0].to(device, non_blocking = True)
...
def main() -> None:
    ...
    parser.add_argument("--mode", type = str, required = True, choices = ["rgb", "t", "base", "adaptive_fpn_lite", "adaptive_fpn_lite_cal", "adaptive_fpn_lite_cal_align", "adaptive_fpn_lite_cal_conf", "adaptive_fpn_lite_cal_dualstem", "adaptive_fpn_lite_cal_misalign", "early", "late", "adaptive_late"])
